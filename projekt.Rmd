...
S spletnega naslova [linked phrase](http://www.oica.net/category/sales-statistics/) sem uvozil tabeli o prodanih osebnih avtomobilih ter komercialnih vozilih po državah v letih od 2005 do 2016. 
...
Iz spletnega mesta [linked phrase](http://www.oica.net/category/vehicles-in-use/) sem uvozil tabeli o uporabi osebnih ter komercialnih vozil po državah v letih od 2005 do 2014.
Podatki so bili v obliki EXCEL (.xlsx).

Stolpci v tabeli so enaki kot pri zgornji (tabela o prodaji)

Podatke o proizvodnji avtomobilov po državah sem prav tako prenesel iz [linked phrase](http://www.oica.net/category/production-statistics/).Podatki so bili v večji meri v obliki PDF zato sem jih za nadalnje delo pretvoril v EXCEL. Podatke sem najprej uredil v štiri tabele. Tabele vsebujejo podatke o proizvodnji določenega tipa avtomobilov v letih od 2005 do 2015. na koncu sem tabele združil.
...
Podatke o proizvodnji avtomobilov glede na proizvajalca pa sem uvozil iz [linked phrase](https://en.wikipedia.org/wiki/List_of_manufacturers_by_motor_vehicle_production#2015). Te podatki so bili v obliki HTML.
